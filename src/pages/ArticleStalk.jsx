...
function ArticleStalk() {
  const [datas, setData] = useState([])

   useEffect(() => {
    axios(
      "https://6480432af061e6ec4d48ebcc.mockapi.io/article-home?page=9&limit=1"
            ...
            <Row>
              {datas.map(item => (
                <Col lg={{ span: 7, offset: 0 }} key={item.id}>
                  <div>
                    <p id="breadcrumbs">Artikel : Ketahui Manfaat Self-Talk untuk Menjaga Kesehatan Mental</p>
